  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="user_table1.php">FREELANCERS</a></li>
        <li><a href="user_request.php">REQUESTS</a></li>
        <li><a href="user_subscription.php">SUBSCRIBERS</a></li>
      
        <li><a href="user_table2.php">OLD REQUEST TABLE</a></li>
        <li><a href="user_log_out.php">LOG OUT</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container-fluid bg-grey">
  ...
  <div class="row">
    ...
    <br>
       <textarea class="form-control" id="review" name="review" placeholder="Review" rows="5"></textarea><br>
      <div class="row">
...
$insert=mysqli_query($db,"INSERT INTO review (name,review) VALUES ('$name','$review')") or die (mysqli_error($db));
