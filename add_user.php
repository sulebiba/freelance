...
<div class="container-fluid bg-grey">
    ...
    <form method='post'>
      <div class="row">
        ...
        <div class="col-sm-6 form-group">
          <input class="form-control" id="service" name="password" placeholder="Password" type="password" required>
        </div>
      </div>
   
      <div class="row">
        <div class="col-sm-12 form-group">
          <button class="btn btn-default pull-right" type="submit" name='submit'>Add</button>
        </div>
      </div>
    </div>
    </form>
...
$insert=mysqli_query($db,"INSERT into user (email,password) VALUES ('$email','$password')");
