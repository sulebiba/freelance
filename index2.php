...
<div class="container-fluid bg-grey">
  <h2 class="text-center">REGISTER AS A FREELANCER</h2>
  <div class="row">
   <div class="col-sm-5">
     ...
     <script>
            ...
            if(name=="" || name==" "){
                ...
                alert("Please fill the service section");
                return false;
            }
            else if(phone=="" || phone==" "){
    ...
    <form method='post' onsubmit="return validate()">
      <div class="row">
        ...
        <div class="col-sm-6 form-group">
          <input class="form-control" id="service" name="service" placeholder="Service you can offer" type="text" required>
        </div>
      </div>
    <div class="row">
        <div class="col-sm-6 form-group">
...
<a href="https://www.facebook.com/Nocv.ng/"><i class="fa fa-twitter"></i></a>
...
$select=mysqli_query($db,"SELECT * FROM service WHERE email='$email'OR phone_no='$phone'");

if(mysqli_num_rows($select)==1){
    echo"<script>alert('Email/Password Exists')</script>"; 
}
else{
$insert=mysqli_query($db,"INSERT INTO service (name,service,phone_no,email,date,location) VALUES ('$name','$service','$phone','$email',
'$date','$location')") or die (mysqli_error($db));
...
$message="Hello,\r \n Welcome to StuckOnGo, \r \n Thank you for Signing up as a freelancer ";
